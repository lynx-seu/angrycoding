...
b(l.replace(document.createElement("div"),["script/fsutils.swf",Math.random()].join("?"),"fsutils-flash",900,900,9,{FlashVars:"onload=jQuery().fsutils.init",wmode:"transparent"})).css({position:"absolute","z-index":"10000000",top:"-100000px",left:"-100000px",overflow:"hidden"}).appendTo(document.body)})})(jQuery);
