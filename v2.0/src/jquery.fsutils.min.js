(function(b){function f(a,c,h){var d=a.fsutils.wrapper,e=d.data("movie");if(!e)return d=Array.prototype.slice.call(arguments),a.fsutils.startupQueue.push(d);e.setParams(h);d.data("callback",c);d.data("target",a);e=a.offset();d.css({left:e.left,top:e.top,width:a.outerWidth(),height:a.outerHeight()})}b.fn.extend({fsutils:{startupQueue:[],wrapper:b({elmToReplace:null,flashIsInstalled:null,defaultFlashVersion:7,replace:function(a,c,h,d,e,b,f){typeof a==="string"&&(a=document.getElementById(a));this.elmToReplace=
a;this.flashIsInstalled=this.checkForFlash(b||this.defaultFlashVersion);if(this.elmToReplace&&this.flashIsInstalled){a="<object"+(window.ActiveXObject?' id="'+h+'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" data="'+c+'"':"");a+=' width="'+d+'"';a+=' height="'+e+'"';a+=">";b="<param";b+=' name="movie"';b+=' value="'+c+'"';b+=">";b+="";var i="",j="",g;for(g in f)i+='<param name="'+g+'" value="'+f[g]+'">',j+=" "+g+'="'+f[g]+'"';this.elmToReplace.innerHTML=a+b+i+('<embed id="'+h+'" src="'+c+
...
openFileDialog:function(a){this.mouseover(function(){var c=b(this);f(c,a,{dialogType:"open",cursor:c.css("cursor"),fileFilter:"*.png;*.jpg;*.gif;*.svg"})});return b(this)},saveFileDialog:function(a){this.mouseover(function(){var c=b(this);f(c,a,{dialogType:"save",cursor:c.css("cursor")})});return b(this)}})})(jQuery);
